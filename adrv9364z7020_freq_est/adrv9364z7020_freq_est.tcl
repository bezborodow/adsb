...
# RTL: Standalone frequency estimator component.
create_bd_cell -type module -reference freq_est_uart u_freq_est_uart
connect_bd_net [get_bd_pins util_ad9361_adc_fifo/dout_clk] [get_bd_pins u_freq_est_uart/clk]
#connect_bd_net [get_bd_pins fir_compiler_0/m_axis_data_tvalid] [get_bd_pins u_freq_est_uart/d_vld_i]
#connect_bd_net [get_bd_pins xlslice_0/Dout] [get_bd_pins u_freq_est_uart/i_i]
#connect_bd_net [get_bd_pins xlslice_1/Dout] [get_bd_pins u_freq_est_uart/q_i]
connect_bd_net [get_bd_pins util_ad9361_adc_fifo/dout_valid_0] [get_bd_pins u_freq_est_uart/d_vld_i]
connect_bd_net [get_bd_pins util_ad9361_adc_fifo/dout_data_0] [get_bd_pins u_freq_est_uart/i_i]
connect_bd_net [get_bd_pins util_ad9361_adc_fifo/dout_data_1] [get_bd_pins u_freq_est_uart/q_i]
...
connect_bd_net [get_bd_pins u_freq_est_uart/uart_tx_o] [get_bd_pins sys_ps7/UART0_RX]
